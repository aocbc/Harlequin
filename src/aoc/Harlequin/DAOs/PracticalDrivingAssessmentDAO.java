		...
		try
		{
			 ...
			 PracticalDriversAssessment Assessment = new PracticalDriversAssessment();
				...
				Assessment.setManualOrAuto(ManualORAuto);
					...
					Assessment.setReverseTestPassed(ReverseTestPassed);
					
					Assessment.setReverseTestComplete(ReverseTestComplete);
					Assessment.setRoadTestComplete(RoadTestComplete);
